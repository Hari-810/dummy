...
class PlannerConfig(RoleConfig):
    def _configure(self) -> None:
        ...
        print(f"DEBUG: Reading prompt file from {self.prompt_file_path}")
        ...
        print(f"DEBUG: Reading compression prompt file from {self.compression_prompt_path}")
...
class Planner(Role):
    ...
    def compose_sys_prompt(self, context: str):
        ...
        print("DEBUG: Formatting instruction template for system prompt")
    ...
    def compose_prompt(
        ...
        print("DEBUG: Composing experience instructions")
        chat_history = [
            format_chat_message(
                role="system",
